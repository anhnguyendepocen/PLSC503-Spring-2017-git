##############################################
# This is some code from PLSC 503
# designed to provide a basic 
# introduction to the R language.
#
# File created January 17, 2017
#
# File last updated January 17, 2017
###############################################
#
# Basics: OBJECTS
#
...
# menu option above, or by using "setwd":
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-Spring-2017-git/master/Data/SCOTUS-votes.csv")
