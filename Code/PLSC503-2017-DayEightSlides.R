...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-Spring-2017-git/master/Data/CountryData2000.csv")
...
(fit$coefficients[2] / beta.hat) * 100 
