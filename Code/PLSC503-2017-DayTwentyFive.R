##########################################
# Code for PLSC 503 - Spring 2017
#
# Eent Count Models (Day Twenty Five)
#
##########################################
# Options:
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-Spring-2017-git/master/Data/nulls.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-Spring-2017-git/master/Data/offsetIR.csv")
